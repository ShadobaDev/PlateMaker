 ...
 *
 * \note Curves / per-channel LUTs are deliberately *not* here yet — the MVP is ICC + the three point
 *       scalars.  They can be added additively later (a new guarded JSON field) without a redesign.
 */
